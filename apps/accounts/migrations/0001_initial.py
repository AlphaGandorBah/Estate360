    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purpose', models.CharField(choices=[('verify_email', 'Verify Email'), ('password_reset', 'Password Reset')], max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('document_type', models.CharField(choices=[('national_id', 'National ID'), ('drivers_license', "Driver's License"), ('passport', 'Passport')], max_length=30)),
                ('document_front_key', models.CharField(max_length=500)),
                ('document_back_key', models.CharField(blank=True, max_length=500)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['status'], name='accounts_la_status_575a50_idx'),
        ),
    ]
